...
[extra]
bio = """
  Joseph is an ECE PhD student at Cornell. His interests vary by week :)
"""
[[extra.authors]]
name = "Joseph Maheshe"
+++

**Code:** [https://github.com/maheshejs/cs6120pr](https://github.com/maheshejs/cs6120pr)

## What was the goal?

The goal of this project was to connect two educationally-focused intermediate languages: Racket's [exprs-lang-v9](https://www.students.cs.ubc.ca/~cs-411/2022w2/v9_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv9..rkt%29._exprs-lang-v9%29%29) subset from UBC's [CPSC411](https://www.students.cs.ubc.ca/~cs-411/2022w2/index.html) (Compiler Construction) course and Bril, the Big Red Intermediate Language. While Bril already has TypeScript and Rust frontends, these support only limited subsets of their source languages. Racket's [exprs-lang-v9](https://www.students.cs.ubc.ca/~cs-411/2022w2/v9_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv9..rkt%29._exprs-lang-v9%29%29), in contrast, is a more expressive subset that includes first-class procedures, making it an ideal candidate for generating interesting Bril benchmarks. The project aimed to compile [exprs-lang-v9](https://www.students.cs.ubc.ca/~cs-411/2022w2/v9_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv9..rkt%29._exprs-lang-v9%29%29) programs—which normally compile all the way down to x64 machine code into Bril programs using the dynamic type extension.

## What did I do?

### Design Overview

My compiler takes programs in [proc-imp-cmf-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._proc-imp-cmf-lang-v7%29%29) (an intermediate representation in the CPSC411 compiler pipeline) and lowers them to Bril JSON. This particular IR was chosen because it sits at the sweet spot after all high-level abstractions have been lowered but before architecture-specific concerns like register allocation.
...
Instead, I chose [proc-imp-cmf-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._proc-imp-cmf-lang-v7%29%29), which perfectly satisfied my requirements:
...
Here's the grammar for [proc-imp-cmf-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._proc-imp-cmf-lang-v7%29%29):
...
The programs being compiled originate from [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29), a much higher-level source language with dynamic types and first-class data. Here's its grammar:
...
The key design challenge was bridging the semantic gap between these educational IRs. Racket's [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29) uses a dynamically-typed, tagged object representation where values are **ptrs** (64-bit words with tag bits encoding type information), while Bril uses explicit `any` types with runtime type checking.

### Implementation: The `bracket` Pass

The compiler is implemented as a single pass called `bracket` that performs a complete translation from [proc-imp-cmf-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._proc-imp-cmf-lang-v7%29%29) to Bril JSON.
...
- Tail calls in `main` untag the result (divide by 8) before printing. Since `print` is not supported in [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29) and its pipelined IRs, the translation replaces `main`'s `ret` instructions with `print` to output the result in Bril.
...
I reimplemented 10 core Bril benchmarks in [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29) and thoroughly tested `bracket`'s translation by comparing interpreter results:
...
| Benchmark | SLOC ([exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29)) | TLOC (Bril)* | Original LOC | Overhead |
|-----------|---------------------:|-------------:|-------------:|---------:|
...
### Expressiveness of [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29)

[exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29) is significantly more expressive than Bril for writing these benchmarks. Most could be written in under 15 lines. For example, factorial using recursion:
...
This demonstrates the fundamental tradeoff: [exprs-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._exprs-lang-v7%29%29)'s high-level abstractions and dynamic typing make writing correct programs much easier, but translation to Bril's lower-level model introduces substantial overhead. The generated code is correct but far from optimal.

### Limitations and Scope Decisions

#### First-Class Procedures and Closures

I had originally planned to include 5 additional benchmarks using higher-order functions and continuation-passing style. However, fully implementing [exprs-lang-v9](https://www.students.cs.ubc.ca/~cs-411/2022w2/v9_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv9..rkt%29._exprs-lang-v9%29%29) with closure conventions proved infeasible because:
...
[exprs-lang-v9](https://www.students.cs.ubc.ca/~cs-411/2022w2/v9_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv9..rkt%29._exprs-lang-v9%29%29) builds on [exprs-lang-v8](https://www.students.cs.ubc.ca/~cs-411/2022w2/v8_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv8..rkt%29._exprs-lang-v8%29%29), which introduces structured data (pairs, vectors) and heap allocation. While the primitives map fairly directly to Bril's memory extension, there are subtle differences:
- [exprs-lang-v8](https://www.students.cs.ubc.ca/~cs-411/2022w2/v8_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv8..rkt%29._exprs-lang-v8%29%29) doesn't free memory; manual memory management in Bril would be required
- [exprs-lang-v8](https://www.students.cs.ubc.ca/~cs-411/2022w2/v8_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv8..rkt%29._exprs-lang-v8%29%29) allows byte-level offsets; Bril's `ptradd` increments by word size (8 bytes)
...
This project successfully bridges two educational compiler infrastructures, enabling Racket's subset to generate Bril benchmarks. The implementation handles complete translation from [proc-imp-cmf-lang-v7](https://www.students.cs.ubc.ca/~cs-411/2022w2/v7_Languages.html#%28def._%28%28lib._cpsc411%2Flangs%2Fv7..rkt%29._proc-imp-cmf-lang-v7%29%29) to Bril JSON, including integration with a GenAI-generated standard library for bitwise operations.
