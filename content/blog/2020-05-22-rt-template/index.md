...
course, running python functions is super slow.
...
I'm defining some key levels to insert a runtime function replacements.
- Instruction level
- Subgraph level
- Basic block level
- Function level
...
Hence this is an experiment to evaluate how robust replacements at each level.
...
are, and has to be created at an intermediate-representation level. To make matters worse,
