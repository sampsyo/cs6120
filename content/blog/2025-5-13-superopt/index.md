...
To enable exploration of different solvers for the exact extraction phase of e-graph-based logic synthesis, we model the extraction problem using linear programming model provided by good\_lp, which provides backends for the [HiGHs](https://highs.dev/), [SCIP](https://scipopt.org/#scipoptsuite), [microlp](https://github.com/Specy/microlp/), and [COIN-OR Branch-and-Cut](https://github.com/coin-or/Cbc) linear programming solvers.
