...
* Convince yourself that your implementation actually works!
    ...
    * You also must check that programs do the same thing when converted to SSA form and back again. Fortunately, [brili][] supports the `set` and `get` instructions, so you can interpret your SSA-form programs if you want to check the midpoint of that round trip.
