...
Another [good example][clang-toot] of this blurriness is that Clang contains a bytecode interpreter for C++.
It uses this to implement [the `constexpr` feature][constexpr] that was added in C++11.
Here's [a simple example of `constexpr` doing its thing][constexpr-ex].
As [CF Bolz-Tereick observes][clang-toot], this leads to a funny situation where Clang, a C++ compiler, contains an interpreter for C++, which in turn contains _another_ compiler to bytecode.
There is an equally funny corollary that Clang compiler engineers [must now care about interpreter performance][clang-bytecode-perf].

[clang-bytecode-perf]: https://developers.redhat.com/articles/2025/10/15/clang-bytecode-interpreter-update#libc___testing
[clang-toot]: https://mastodon.social/@cfbolz/115429061449688876#.
[constexpr]: https://iamsorush.com/posts/cpp-constexpr/
[constexpr-ex]: https://godbolt.org/#g:!((g:!((g:!((h:codeEditor,i:(filename:'1',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,selection:(endColumn:2,endLineNumber:12,positionColumn:2,positionLineNumber:12,selectionStartColumn:2,selectionStartLineNumber:12,startColumn:2,startLineNumber:12),source:'int+constexpr+fib(int+n)+%7B%0A++++if+(n+%3C%3D+1)+%7B%0A++++++++return+1%3B%0A++++%7D+else+%7B%0A++++++++return+fib(n+-+1)+%2B+fib(n+-+2)%3B%0A++++%7D%0A%7D%0A%0Aint+example()+%7B%0A++++constexpr+int+res+%3D+fib(8)%3B%0A++++return+res%3B%0A%7D'),l:'5',n:'0',o:'C%2B%2B+source+%231',t:'0')),k:50,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:output,i:(compilerName:'armv8-a+clang+(trunk)',editorid:1,fontScale:14,fontUsePx:'0',j:1,wrap:'1'),l:'5',n:'0',o:'Output+of+armv8-a+clang+21.1.0+(Compiler+%231)',t:'0')),header:(),k:25,l:'4',n:'0',o:'',s:0,t:'0'),(g:!((h:compiler,i:(compiler:armv8-clang2110,filters:(b:'0',binary:'1',binaryObject:'1',commentOnly:'0',debugCalls:'1',demangle:'0',directives:'0',execute:'1',intel:'0',libraryCode:'0',trim:'1',verboseDemangling:'0'),flagsViewOpen:'1',fontScale:14,fontUsePx:'0',j:1,lang:c%2B%2B,libs:!(),options:'-O2',overrides:!(),selection:(endColumn:1,endLineNumber:1,positionColumn:1,positionLineNumber:1,selectionStartColumn:1,selectionStartLineNumber:1,startColumn:1,startLineNumber:1),source:1),l:'5',n:'0',o:'+armv8-a+clang+21.1.0+(Editor+%231)',t:'0')),k:25,l:'4',n:'0',o:'',s:0,t:'0')),l:'2',n:'0',o:'',t:'0')),version:4
